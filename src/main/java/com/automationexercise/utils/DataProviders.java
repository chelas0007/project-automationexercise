...
public class DataProviders {
	...
	@DataProvider(name="registerAccountDetails")
	public Object[][] dp1(){
		return new Object[][] {
			
			{"Rudra","rudra@gmail.com","newpassword123","12","October","1997","Rudra","Chelas","Riskit",
	...
	public Object[][] dp2(){
		return new Object[][] {
			...
			{"rudra@gmail.com","newpassword123"}
		};
		
	}

	@DataProvider(name="registerUsingExistingUser")
	public Object[][] dp3(){
		return new Object[][] {
